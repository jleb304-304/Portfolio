...
export default function IndividualScreen({ navigation }) {
  ...
  const setBudgetsFromStorage = (budgets_string) => {
    ...
    let budgetIndex = budgetList.findIndex((budget) => {return budget.title === 'Individual'});
  ...
  return (
    <PaperProvider>
      <View style={styles.container}>
        <View style={styles.headerRow}>
          <View style={styles.headerRow1}>
            <Header title="YOUR BUDGET" dropdown="timePeriod"/>
          </View>
          <View style={styles.headerRow2}>
            <TopCard individual remaining={totalRemaining} budget={totalBudget} buttonTitle="ADD EXPENSE" onPress={() => {setAddExpenseModalVisible(true)}}/>
          </View>
        </View>
      ...
      <Overlay
        title="ADD INDIVIDUAL EXPENSE"
        content={(<AddExpenseContent budget={budgets[selectedBudgetIndex]} subBudgets={subBudgets} editSubBudget={editSubBudget} onSave={addExpense} setModalVisible={setAddExpenseModalVisible}/>)}
        modalVisible={addExpenseModalVisible}
        setModalVisible={setAddExpenseModalVisible}
      />
      <Overlay
        title="ADD INDIVIDUAL SUB BUDGET"
      ...
      />
      <Overlay
        title="EDIT INDIVIDUAL SUB BUDGET"
